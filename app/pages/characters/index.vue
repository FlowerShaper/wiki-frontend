    ...
    <PageBase>
        <div class="flex max-w-full flex-col gap-4 text-lg" v-if="data">
            ...
            <div class="grid gap-4 grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8">
                <NuxtLink :to="`/characters/${char.id}`" class="w-full rounded-lg bg-background-2 flex flex-col transition-colors duration-300 hover:bg-background-3 hover:duration-75" v-for="char in data">
