...
const { data } = await api.PerformGet<{
    ...
    <PageBase>
        <div class="flex max-w-full flex-col gap-4 text-lg" v-if="data">
            ...
            <table class="">
                ...
                <tbody>
                    <tr class="first:rounded-t-lg last:rounded-b-lg odd:bg-background-2 even:bg-background-3" v-for="album in data.albums">
            ...
            <table>
                ...
                <tbody>
                    <tr class="first:rounded-t-lg last:rounded-b-lg odd:bg-background-2 even:bg-background-3" v-for="track in data.tracks">
