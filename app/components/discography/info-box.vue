...
<template>
    <div class="mb-3 w-full overflow-hidden rounded-lg bg-background-2 md:mx-auto md:w-72 lg:float-right lg:ml-4">
        ...
        />
        <div class="grid grid-flow-col border-b-2 border-b-background-3" v-if="item.covers?.length">
            <div
