        ...
        <div v-if="state.overlays.profile" @click="Close" class="pointer-events-auto fixed left-0 top-0 size-full bg-black/25">
            <div class="mx-auto w-full 2xl:w-page">
                <div
                    ...
                    class="ml-auto mt-16 flex w-full origin-top-right flex-col gap-2 rounded-b-xl bg-background-2 p-2 md:mr-6 md:mt-20 md:w-64 md:rounded-xl"
                >
                    <template v-if="!react.menu">
                        <div class="flex flex-col">
                            <div class="overlap-grid h-20 w-full overflow-hidden rounded">
                                ...
                                <div class="bg-background-1 opacity-50"></div>
                            </div>
                        ...
                        <div class="h-1 w-full px-2">
                            <div class="size-full bg-background-3"></div>
                        </div>
                        <div class="flex flex-col">
